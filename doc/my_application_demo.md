...
2. When you click on the hyperlink of the `EksJavaDemoApp`, you will be taken to myApplications directly. Here, if you go into manage resources, you will see all the resources that belong under `EksJavaDemoApp`. 
   3. ![img.png](imgs/my_app_2.png)